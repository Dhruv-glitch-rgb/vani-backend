...
## Features
- Discovers nearby active VANI nodes, smartphones, and workstations on the local network.
- Secure QR and PIN-based device pairing.
- Cross-device telemetry and remote execution triggers.
