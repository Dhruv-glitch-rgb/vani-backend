# Frequently Asked Questions (FAQ) — VANI-xAI

> Platform: VANI-xAI (Vāṇī Adhyātmik Navīn Intellect)  
> URL: https://vani-nzdrsr.web.app/faq
...
## 4. Can I use local offline LLMs?
Yes. VANI-xAI integrates with Ollama, LM Studio, and local OpenAI-compatible inference servers via `/api/local-llm/*`.

## 5. Where can I find the API documentation?
OpenAPI 3.1.0 specifications are hosted at `/openapi.json` and `/openapi.yaml`. LLM indexes are at `/llms.txt`.
